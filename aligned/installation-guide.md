...
```bash
curl -L https://raw.githubusercontent.com/val1gators/aligned_layer/main/batcher/aligned/install_aligned.sh | bash
```
...
```bash
curl -L https://raw.githubusercontent.com/val1gators/aligned_layer/main/batcher/aligned/get_proof_test_files.sh | bash
```
